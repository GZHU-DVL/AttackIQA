...
def witness(
    ...
    """Compute the persistence intervals for the models of features using the witness complex.

    Args:
        features: Array with shape (N_samples, data_dim) representing the models.
