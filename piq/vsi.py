...
def vsi(prediction: torch.Tensor, target: torch.Tensor, reduction: str = 'mean', data_range: Union[int, float] = 1.,
    ...
    Args:
        ...
        omega_0: coefficient to get logs Gabor filter at SDSP
        sigma_f: coefficient to get logs Gabor filter at SDSP
...
def sdsp(x: torch.Tensor, data_range: Union[int, float] = 255, omega_0: float = 0.021, sigma_f: float = 1.34,
    ...
    Args :
        ...
        omega_0: coefficient for logs Gabor filter
        sigma_f: coefficient for logs Gabor filter
...
def _log_gabor(size: Tuple[int, int], omega_0: float, sigma_f: float) -> torch.Tensor:
    r"""Creates logs Gabor filter

    Args:
        size: size of the requires logs Gabor filter
